...
describe('humps', function() {
  ...
  describe('.camelizeKeys', function() {
    it('converts simple object keys to camelcase', function() {
      assert.deepEqual(
        humps.camelizeKeys(this.simple_obj),
        this.simpleCamelObj
      );
    });
    ...
    it('converts complex object keys to camelcase', function() {
      assert.deepEqual(
        humps.camelizeKeys(this.complex_obj),
        this.complexCamelObj
      );
    });
  ...
  describe('.decamelizeKeys', function() {
    it('converts simple objects with camelcased keys to underscored', function() {
      assert.deepEqual(
        humps.decamelizeKeys(this.simpleCamelObj),
        this.simple_obj
      );
    });
    ...
    it('converts complex objects with camelcased keys to underscored', function() {
      assert.deepEqual(
        humps.decamelizeKeys(this.complexCamelObj),
        this.complex_obj
      );
    });
  ...
  describe('.pascalizeKeys', function() {
    it('converts simple object keys to PascalCase', function() {
      assert.deepEqual(
        humps.pascalizeKeys(this.simple_obj),
        this.simplePascalObj
      );
    });
    ...
    it('converts complex object keys to PascalCase', function() {
      assert.deepEqual(
        humps.pascalizeKeys(this.complex_obj),
        this.complexPascalObj
      );
    });
  ...
  describe('.depascalizeKeys', function() {
    it('converts simple object with PascalCase keys to underscored', function() {
      assert.deepEqual(
        humps.depascalizeKeys(this.simplePascalObj),
        this.simple_obj
      );
    });
    ...
    it('converts complex object with PascalCase keys to underscored', function() {
      assert.deepEqual(
        humps.depascalizeKeys(this.complexPascalObj),
        this.complex_obj
      );
    });
  ...
  describe('.camelize', function() {
    ...
    it('converts hyphenated strings not to camelcase', function() {
      assert.equal(humps.camelize('hello-world'), 'hello-world');
      assert.equal(humps.camelize('hello-world-1'), 'hello-world-1');
    });
  ...
  describe('.pascalize', function() {
    ...
    it('converts hyphenated strings not to PascalCase', function() {
      assert.equal(humps.pascalize('hello-world'), 'Hello-world');
    });
